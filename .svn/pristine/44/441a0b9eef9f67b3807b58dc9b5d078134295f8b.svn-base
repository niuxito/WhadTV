...
<?php echo $this->Form->create('Dispositivo',array('action'=>'asignar')); ?>

<label for="fld_1" class="fld left mdm">
<h3>Nombre del dispositivo:<span class="obl">*</span></h3>
...
<h3>ID del dispositivo:<span class="obl">*</span></h3>
<?php echo $this->Form->input("id",array('class'=>'inpt', 'label'=>false)); ?>
<!--<input id="fld_2" class="inpt" type="text" name="[Dispositivo][id]" value="" />-->
</label>

<div class="msg lft min">
Indica aquí el ID propio del dispositivo contratado.
</div>
