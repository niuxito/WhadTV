...
Bienvenido a WhadTV </br>

Este mail te ha sido enviado porque alguien se ha registrado con tu cuenta de correo en WhadTV.com.
...
<a class="prv lbr " href="http://<?php echo HOST.DIRECTORIO; ?>/users/activar/<?php echo $hash; ?>"><img src="http://whadtv.com/img/ico_validar.png" /><br />Validar cuenta</a>
...
<a class="prv lbr" href="http://<?php echo HOST.DIRECTORIO; ?>/users/rechazo/<?php echo $hash ; ?>"><img src="http://whadtv.com/img/ico_cancelar.png" /><br />Cancelar</a>
