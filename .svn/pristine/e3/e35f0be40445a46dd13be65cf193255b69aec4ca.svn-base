...
<?php echo $this->Form->create('ListaVideo');?>
	<fieldset>
		<legend><?php echo __('Edit Lista Video'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ListaVideo.idLista')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ListaVideo.idLista'))); ?></li>
